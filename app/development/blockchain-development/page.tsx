import { client, SERVICES_QUERY, TESTIMONIALS_QUERY, TECH_ICONS_QUERY, PROJECTS_QUERY } from '@/lib/sanity';
...
export default async function BlockchainDevelopmentPage() {
  ...
  const techIcons: TechIcon[] = await client.fetch(TECH_ICONS_QUERY);
